...
for jentry in xrange(entries):
  ...
  wires = tree.wireListCheat
  times = tree.timeListCheat
  tpcs = tree.TPCListCheat
  adcs = tree.integralListCheat
  planes = tree.planeListCheat
...
#  wholeEvent = np.delete(wholeEvent, slice(0,rowsToRemove), axis=0)
  ...
  Plotlocation = "cheatPlots/ele_" + str(jentry) + "_cheat.png"
